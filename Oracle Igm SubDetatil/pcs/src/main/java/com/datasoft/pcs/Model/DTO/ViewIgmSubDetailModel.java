...
public class ViewIgmSubDetailModel {
    ...
    public ViewIgmSubDetailModel(Integer id, Integer IGM_id, String import_Rotation_No, Integer line_No,
                                 ...
                                 String delivery_block_stat, String ConsigneeDesc,String NotifyDesc,String navy_comments,Integer Submitee_Org_Id,
                                 ...
                                 Integer auto_no,String final_amendment,String appsubmitdate,String navy_response_to_port,String permission_no,String Submission_Date) {
    ...
    public Integer getIGM_id() {
        return IGM_id;
    }

    public void setIGM_id(Integer IGM_id) {
        this.IGM_id = IGM_id;
    }
    ...
    public Integer getSubmitee_Org_Id() {
        return Submitee_Org_Id;
    }

    public void setSubmitee_Org_Id(Integer submitee_Org_Id) {
    ...
    public Integer getAIN_No() {
        return AIN_No;
    }

    public void setAIN_No(Integer AIN_No) {
        this.AIN_No = AIN_No;
    }
