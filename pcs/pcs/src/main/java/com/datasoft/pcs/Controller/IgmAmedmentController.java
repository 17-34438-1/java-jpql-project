...
//    @RequestMapping(value = "/getViewIgmSubDetailContainer/{container_no}/{rotation}/{bl_no}/{igmType}/{priorValue}/{newValue}/{login_id}/{cont_status}", method= RequestMethod.POST)
//    @ResponseBody
//    public List getViewIgmSubDetailContainer(@PathVariable String container_no,@PathVariable String rotation , @PathVariable String bl_no, @PathVariable String igmType,@PathVariable  String priorValue,@PathVariable String newValue,@PathVariable  String login_id,@PathVariable String cont_status
//    )  {
//        String Rotation=rotation.replace('_','/');
//        System.out.println("rafiqul:"+Rotation);
//        List list =new ArrayList<>();
//        list = igmAmedmentChangeContainerStatusService.getViewIgmSubDetailContainer(container_no,Rotation,bl_no,igmType,priorValue,newValue,login_id,cont_status);
//
//        return list;
//
//    }
